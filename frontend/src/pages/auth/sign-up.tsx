...
import { Sprout, Sparkles, TrendingUp, Users } from "lucide-react";
...
export default function SignUpPage() {
  ...
  useEffect(() => {
    const savedRole = localStorage.getItem("pineder-user-role");
  ...
  const handleRoleSelect = (role: "mentor" | "student") => {
    ...
    localStorage.setItem("pineder-user-role", role);
  };
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Create your Pinecone Mentorship Platform account"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>

      <div
        className={`min-h-screen ${isDarkMode ? "bg-[#0F0E0E]" : "bg-white"}`}
      >
        {/* Floating Background Elements */}
        ...
        <motion.nav
          ...
          className="fixed top-0 left-0 right-0 z-50 border-0 bg-background/80 backdrop-blur-md no-border"
          style={{
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <Link href="/">
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--pico-secondary)] to-[var(--pico-accent)] flex items-center justify-center">
              ...
              <div className="flex items-center space-x-4">
                {/* The ThemeSwitcher component was removed, so this div is now empty */}
              </div>
            </div>
          </div>
        </motion.nav>
                ...
                >
                  <CardHeader className="text-center">
                    <CardTitle className={`text-2xl font-bold ${textColor}`}>
                      {selectedRole ? "Create Account" : "Choose Your Role"}
                    </CardTitle>
                    <CardDescription className={mutedTextColor}>
                      {selectedRole
                        ? `You are signing up as a ${selectedRole}.`
                        : "Select whether you want to join as a student or mentor."}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {!selectedRole ? (
                      <div className="space-y-3">
                        <button
                          ...
                          className="w-full rounded-xl border border-emerald-500/40 bg-emerald-500/10 px-4 py-3 text-left transition hover:bg-emerald-500/20"
                        >
                          <div className="text-base font-semibold text-emerald-600 dark:text-emerald-300">
                            I am a student
                          </div>
                          <div className="text-sm text-slate-600 dark:text-slate-300">
                            I want to learn, book sessions, and grow.
                          </div>
                        </button>
                        ...
                        <button
                          ...
                          className="w-full rounded-xl border border-violet-500/40 bg-violet-500/10 px-4 py-3 text-left transition hover:bg-violet-500/20"
                        >
                          <div className="text-base font-semibold text-violet-600 dark:text-violet-300">
                            I am a mentor
                          </div>
                          <div className="text-sm text-slate-600 dark:text-slate-300">
                            I want to guide students and offer sessions.
                          </div>
                        </button>
                      </div>
                    ) : (
                      <>
                        ...
                        <button
                          ...
                          className="mt-3 text-sm font-medium text-[var(--pico-primary)] hover:text-[var(--pico-secondary)]"
                        >
                          Change role
                        </button>
                      </>
                  ...
                  {selectedRole && (
                    <div className="flex justify-center items-center text-[16px] mb-3 gap-2">
                ...
                <div className="relative w-full overflow-hidden shadow-2xl h-96 rounded-2xl">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative z-10 text-center">
                      ...
                      >
                        Join our community and connect with expert mentors
                      </p>
